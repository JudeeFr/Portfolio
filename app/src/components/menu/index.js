	...
	return (
		<div>
             <div className="btn-menu" onClick={() => {menuIconClick()}} >
              {menuCollapse ? (
                <svg className="btn-open" width="40px" height="40px" viewBox="-0.5 0 25 25"    xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="btn-close" width="40px" height="40px" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
